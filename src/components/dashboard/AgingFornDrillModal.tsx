...
const EMPRESA_MAP: Record<string, string[]> = {
  "ME FUNDAÇÕES BRASIL LTDA": ["ME FUNDAÇÕES BRASIL LTDA", "MEFB", "Mota Engil Fundações", "MOTA ENGIL FUNDAÇÕES"],
  ...
  "MOTA-ENGIL BRASIL S/A": ["MOTA-ENGIL BRASIL S/A", "Mota-Engil Brasil", "Mota Engil Brasil", "MOTA ENGIL BRASIL S.A."],
  ...
  "Mota-Engil Brasil": ["MOTA-ENGIL BRASIL S/A", "Mota-Engil Brasil", "Mota Engil Brasil", "MOTA ENGIL BRASIL S.A."],
  "Mota Engil Brasil": ["MOTA-ENGIL BRASIL S/A", "Mota Engil Brasil", "Mota-Engil Brasil", "MOTA ENGIL BRASIL S.A."],
  "Macaé": ["MOTA ENGIL - MACAE"],
  "MOTA ENGIL - MACAE": ["MOTA ENGIL - MACAE"],
  "Reduc": ["REDUC", "Reduc"],
  "Alsub": ["CONSÓRCIO ECB SEA_ALSUB", "Consórcio Alsub", "Alsub"],
  "Consórcio Alsub": ["CONSÓRCIO ECB SEA_ALSUB", "Consórcio Alsub", "Alsub"],
  "Mota Engil Fundações": ["ME FUNDAÇÕES BRASIL LTDA", "MEFB", "Mota Engil Fundações", "MOTA ENGIL FUNDAÇÕES"],
  "MOTA ENGIL FUNDAÇÕES": ["ME FUNDAÇÕES BRASIL LTDA", "MEFB", "Mota Engil Fundações", "MOTA ENGIL FUNDAÇÕES"],
  "MOTA ENGIL BRASIL S.A.": ["MOTA-ENGIL BRASIL S/A", "MOTA ENGIL BRASIL S.A.", "Mota Engil Brasil", "Mota-Engil Brasil"],
  "MEBR PARTICIPAÇÕES S.A.": ["MEBR PARTICIPAÇÕES S.A.", "MEBR Participações S.A.", "MEBR", "MEBR - Part. Consultoria"],
...
const resolvePeriod = (p: string) => p;
